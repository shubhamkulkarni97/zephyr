...
// {
//     k_queue_append((struct k_queue *)queue, item);
//     return 0;
// }
...
// {
//     // if (block_time_tick == OSI_FUNCS_TIME_BLOCKING) {
//     //     return (uint32_t)xEventGroupWaitBits(event, bits_to_wait_for, clear_on_exit, wait_for_all_bits, 0xffffffff);
//     // } else {
...
// void vEventGroupDelete(void *ptr)
// {
//     return NULL;
// }

// uint32_t xEventGroupSetBits(void *ptr,uint32_t bits)
// {
//     return 0;
// }

// uint32_t xEventGroupClearBits(void *ptr,uint32_t bits)
// {
//     return 0;
// }
